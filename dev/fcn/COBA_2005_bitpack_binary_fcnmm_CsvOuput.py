...
def benchmark_post_conn(
    ...
    csv_recorder = RP.CSV_record(f'bitpack_post_bs{batch_size}', 'fcnmm', 'coba', duration=duration, conn=conn_num)
...
def benchmark_pre_conn(
    ...
    csv_recorder = RP.CSV_record(f'bitpack_pre_bs{batch_size}', 'fcnmm', 'coba', duration=duration, conn=conn_num)
