...
#define DEFINE_JITSMV_NOTRANS(SFX, WEIGHT_T, ACC_T, READ_W, ATOMIC_ADD, WARP_REDUCE) \
...
#define DEFINE_JITSMV_TRANS(SFX, WEIGHT_T, ACC_T, READ_W, ATOMIC_ADD)          \
...
DEFINE_JITSMV_NOTRANS(_f64, double, double, READ_F64, atomic_add_f64, warp_reduce_sum_f64)
DEFINE_JITSMV_NOTRANS(_f16, __half, float, READ_F16, atomic_add_f16, warp_reduce_sum_f32)
DEFINE_JITSMV_NOTRANS(_bf16, __nv_bfloat16, float, READ_BF16, atomic_add_bf16, warp_reduce_sum_f32)

DEFINE_JITSMV_TRANS(_f64, double, double, READ_F64, atomic_add_f64)
DEFINE_JITSMV_TRANS(_f16, __half, float, READ_F16, atomic_add_f16)
DEFINE_JITSMV_TRANS(_bf16, __nv_bfloat16, float, READ_BF16, atomic_add_bf16)

#define FFI_JITSMV(NAME, KERNEL, SFX, WEIGHT_T)                             \
void NAME##SFX(                                                             \
    const BE::Tensor weight,                                                \
    const BE::Tensor clen,                                                  \
    const BE::Tensor seed,                                                  \
...
// @BE jitsmv_notrans_f64
FFI_JITSMV(jitsmv_notrans, notrans, _f64, double)
// @BE jitsmv_notrans_f16
FFI_JITSMV(jitsmv_notrans, notrans, _f16, __half)
// @BE jitsmv_notrans_bf16
FFI_JITSMV(jitsmv_notrans, notrans, _bf16, __nv_bfloat16)

// @BE jitsmv_trans_f64
FFI_JITSMV(jitsmv_trans, trans, _f64, double)
// @BE jitsmv_trans_f16
FFI_JITSMV(jitsmv_trans, trans, _f16, __half)
// @BE jitsmv_trans_bf16
FFI_JITSMV(jitsmv_trans, trans, _bf16, __nv_bfloat16)
