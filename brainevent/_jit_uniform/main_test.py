...
class Test_JITC_To_Dense:
    ...
    def test_vjp(self, shape, corder, wlow, whigh):
        ...
        expected_wlow_grad = (ct * (mask - base)).sum()
        ...
        jax.block_until_ready(
            (base, mask, ct, primals, true_wlow_grad,
    ...
    def test_jvp(self, shape, corder, wlow, whigh):
        ...
        jax.block_until_ready((base, mask, tagents[0], tagents[1], primals1, true_grad, primals2, jitc_grad))
