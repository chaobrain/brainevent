...
class TestJitcCsrMatvecHomo:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        shape = (2, 3)
        seed = 1234
        result = _jitc_matvec_homo(weight,
                                       conn_prob,
                                       v,
                                       seed=seed,
                                       shape=shape,
...
class TestJitcCsrMatvecUniform:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        result = _jitc_matvec_uniform(w_low,
                                          w_high,
                                          conn_prob,
                                          v,
                                          seed=seed,
    ...
    def test_random_connectivity(self, shape, prob, transpose, outdim_parallel):
        ...
        r1 = _jitc_matvec_uniform(w_low,
                                      ...
                                      transpose=transpose,
                                      outdim_parallel=outdim_parallel)
        r2 = _jitc_matvec_uniform(w_low, w_high, prob, vector,
                                      seed=seed,
                                      shape=shape,
                                      transpose=transpose,
                                      outdim_parallel=outdim_parallel)
    ...
    def _test_jvp(self, prob, transpose, outdim_parallel):
        ...
        def f_brainevent(x, w_low, w_high):
            return _jitc_matvec_uniform(w_low,
                                            w_high,
                                            prob,
                                            x,
                                            seed=seed,
...
class TestJitcCsrMatvecNormal:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        result = _jitc_matvec_normal(w_mu,
                                         w_sigma,
                                         conn_prob,
                                         v,
                                         seed=seed,
    ...
    def test_jvp(self, prob, transpose, outdim_parallel):
        ...
        def f_brainevent(x, w_mu, w_sigma):
            return _jitc_matvec_uniform(w_mu,
                                            w_sigma,
                                            prob,
                                            x,
                                            seed=seed,
        ...
        out1, jvp_x1 = jax.jvp(f_brainevent,
                               (x, jnp.array(w_mu), jnp.array(w_sigma)),
                               (jnp.ones_like(x), jnp.array(1.0), jnp.array(1.0)))
...
class TestJitcCsrMatmatHomo:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        result = _jitc_matmat_homo(weight,
                                       conn_prob,
                                       B,
                                       seed=seed,
                                       shape=shape,
    ...
    def test_random_connectivity(self, shape, batch_size, weight, prob, transpose, outdim_parallel):
        ...
        r1 = _jitc_matmat_homo(weight,
                                   ...
                                   transpose=transpose,
                                   outdim_parallel=outdim_parallel)
        r2 = _jitc_matmat_homo(weight, prob, B,
                                   seed=seed,
                                   shape=shape,
                                   transpose=transpose,
                                   outdim_parallel=outdim_parallel)
...
class TestJitcCsrMatmatUniform:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        result = _jitc_matmat_uniform(w_low,
                                          w_high,
                                          conn_prob,
                                          B,
                                          seed=seed,
    ...
    def test_random_connectivity(self, shape, batch_size, prob, transpose, outdim_parallel):
        ...
        r1 = _jitc_matmat_uniform(w_low, w_high, prob, B,
                                      seed=seed,
                                      shape=shape,
                                      transpose=transpose,
                                      outdim_parallel=outdim_parallel)
        r2 = _jitc_matmat_uniform(w_low, w_high, prob, B,
                                      seed=seed,
                                      shape=shape,
                                      transpose=transpose,
                                      outdim_parallel=outdim_parallel)
    ...
    def _test_jvp(self, prob, transpose, outdim_parallel):
        ...
        def f_brainevent(X, w_low, w_high):
            return _jitc_matmat_uniform(w_low,
                                            w_high,
                                            prob,
                                            X,
                                            seed=seed,
...
class TestJitcCsrMatmatNormal:
    ...
    def test_zero_weight(self, transpose, outdim_parallel):
        ...
        result = _jitc_matmat_normal(w_mu,
                                         w_sigma,
                                         conn_prob,
                                         B,
                                         seed=seed,
    ...
    def test_random_connectivity(self, shape, batch_size, prob, transpose, outdim_parallel):
        ...
        r1 = _jitc_matmat_normal(w_mu, w_sigma, prob, B,
                                     seed=seed,
                                     shape=shape,
                                     transpose=transpose,
                                     outdim_parallel=outdim_parallel)
        r2 = _jitc_matmat_normal(w_mu, w_sigma, prob, B,
                                     seed=seed,
                                     shape=shape,
                                     transpose=transpose,
                                     outdim_parallel=outdim_parallel)
    ...
    def _test_jvp(self, prob, transpose, outdim_parallel):
        ...
        def f_brainevent(X, w_mu, w_sigma):
            return _jitc_matmat_normal(w_mu,
                                           w_sigma,
                                           prob,
                                           X,
                                           seed=seed,
