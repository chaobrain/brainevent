...
class TestBinaryArray:
    ...
    def test_comparison_methods(self):
        ...
        event_array_a = BinaryArray(value_a)
        value_b = np.array([3, 2, 1])
        event_array_b = BinaryArray(value_b)
    ...
    def test_bitwise_operations(self):
        event_array = BinaryArray(np.array([1, 2, 3, 4]))
        ...
        event_array_copy = BinaryArray(np.array([1, 2, 3, 4]))
    ...
    def test_numpy_methods(self):
        # Test all
        event_array = BinaryArray(np.array([[True, False], [True, True]]))
        assert not event_array.all()
        assert np.array_equal(event_array.all(axis=0), np.array([True, False]))

        # Test any
        event_array = BinaryArray(np.array([[True, False], [False, False]]))
        ...
        # Test clip
        event_array = BinaryArray(np.array([1, 2, 3, 4, 5]))
    ...
    def test_trigonometric_functions(self):
        event_array = BinaryArray(np.array([0, np.pi / 4, np.pi / 2]))
    ...
    def test_array_manipulation(self):
        # Test reshape
        event_array = BinaryArray(np.array([1, 2, 3, 4, 5, 6]))
    ...
    def test_sorting_and_searching(self):
        event_array = BinaryArray(np.array([3, 1, 4, 2]))
    ...
    def test_additional_math_operations(self):
        # Test round
        event_array = BinaryArray(np.array([1.1, 2.5, 3.9]))
