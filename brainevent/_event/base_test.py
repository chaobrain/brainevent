...
import jax
from brainevent import BaseArray, EventArray
...
class TestBaseArrayMinimalAPI:
    ...
    def test_with_value_returns_new_instance(self):
        ...
        assert isinstance(arr2, EventArray)
    ...
    def test_pytree_roundtrip(self):
        arr = EventArray(np.array([1, 0, 1], dtype=np.float32))
