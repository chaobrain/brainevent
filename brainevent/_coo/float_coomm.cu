 ...
 * --------------------
 * coomm_ct_nt_{f32,f64,f16,bf16}  -- CT kernel, non-transposed SpMM
 * coomm_ct_t_{f32,f64,f16,bf16}   -- CT kernel, transposed SpMM
 * coomm_wpe_nt_{f32,f64,f16,bf16} -- WPE kernel, non-transposed SpMM
 * coomm_wpe_t_{f32,f64,f16,bf16}  -- WPE kernel, transposed SpMM
 */
