...
multiplication operation to registered backends (``numba``, ``pallas``),
...
spfloat_densemv_p.def_cuda_raw_kernel(_spfloat_densemv_cuda_kernel, asdefault=True)
...
spfloat_densemm_p.def_cuda_raw_kernel(_spfloat_densemm_cuda_kernel, asdefault=True)
