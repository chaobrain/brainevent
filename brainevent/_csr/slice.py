...
csr_slice_rows_p.def_cuda_kernel(_csr_slice_rows_cuda_kernel_generator)
...
csr_slice_rows_grad_p.def_cuda_kernel(_csr_slice_rows_grad_cuda_kernel_generator)
