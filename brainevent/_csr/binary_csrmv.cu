...
// =========================================================================
//
// Backing kernels for ``binary_csrmv_indexed`` in the *unfavorable* direction
...
// fused into the scatter so only active rows/columns are read.  Homogeneous
// weights need no perm variant (every slot reads ``weights[0]``); the Python
// dispatcher reuses the plain homogeneous kernels above for that case.
