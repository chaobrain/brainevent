...
spfloat_csrmv_p.def_cuda_raw_kernel(_spfloat_csrmv_cuda_kernel, asdefault=True)
...
spfloat_csrmm_p.def_cuda_raw_kernel(_spfloat_csrmm_cuda_kernel, asdefault=True)
