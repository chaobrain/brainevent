...
spfloat_fcnmv_p.def_cuda_raw_kernel(_spfloat_fcnmv_cuda_kernel, asdefault=True)
...
spfloat_fcnmm_p.def_cuda_raw_kernel(_spfloat_fcnmm_cuda_kernel, asdefault=True)
