 ...
 *
 * TVM FFI entry points (all named binary_fcnmv_<mode>_<spike>_<kernel>_<dtype>):
 *   binary_fcnmv_gather_bool_warp_{f32,f64,f16,bf16}
 *   binary_fcnmv_gather_bool_basic_{f32,f64,f16,bf16}
 *   binary_fcnmv_gather_float_warp_{f32,f64,f16,bf16}
 *   binary_fcnmv_gather_float_basic_{f32,f64,f16,bf16}
 *   binary_fcnmv_scatter_bool_warp_{f32,f64,f16,bf16}
 *   binary_fcnmv_scatter_bool_basic_{f32,f64,f16,bf16}
 *   binary_fcnmv_scatter_float_warp_{f32,f64,f16,bf16}
 *   binary_fcnmv_scatter_float_basic_{f32,f64,f16,bf16}
 *
 ...
 *   spikes   -- [n_post] (gather) or [n_pre] (scatter) spike/activity vector
 *   output   -- [n_pre] (gather) or [n_post] (scatter) result tensor
