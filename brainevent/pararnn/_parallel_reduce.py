...
parallel_reduce_diag_p.def_cuda_kernel(_reduce_diag_cuda_kernel, asdefault=True)
...
parallel_reduce_block_diag_p.def_cuda_kernel(_reduce_block_diag_cuda_kernel, asdefault=True)
