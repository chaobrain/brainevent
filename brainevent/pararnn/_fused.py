...
fused_gru_diag_fwd_p.def_cuda_kernel(_fused_gru_fwd_cuda_kernel, asdefault=True)
...
fused_gru_diag_bwd_p.def_cuda_kernel(_fused_gru_bwd_cuda_kernel, asdefault=True)
...
fused_lstm_cifg_diag_fwd_p.def_cuda_kernel(_fused_lstm_fwd_cuda_kernel, asdefault=True)
...
fused_lstm_cifg_diag_bwd_p.def_cuda_kernel(_fused_lstm_bwd_cuda_kernel, asdefault=True)
